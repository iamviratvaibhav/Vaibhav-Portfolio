...
//       <h1 className='text-3xl sm:text-4xl font-bold text-white'> WORK EXPERIENCE</h1>
//       <div className='w-32 h-1 bg-purple-500 mx-auto mt-4'></div>
//       <p className='text-gray-400 mt-4 text-lg font-semibold'>A little but preciouse experience in my Tech. life journey</p>

//       {/* experience timeline */}
//       <div className='relative'></div>
//       {/* vertical line */}
//       <div className='absolute sm:left-1/2 left-0 transform -translate-x-1/2 sm:translate-x-0 w-1 bg-white height-full'></div>
//       {/* experience enteries */}
    ...
    >
      ...
      <div className="relative">
        ...
        {experiences.map((experience, index) => (
          ...
          >
            {/* Timeline Circle */}
            <div className="absolute sm:left-1/2 left-0 transform -translate-x-1/2 bg-gray-400 border-4 border-[#8245ec] w-12 h-12 
            sm:w-16 sm:h-16 rounded-full flex justify-center items-center z-10">
