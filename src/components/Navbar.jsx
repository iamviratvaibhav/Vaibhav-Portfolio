...
function Navbar() {
  ...
  return (
    // <nav className={`fixed top-0 left-0 w-full z-50 px-4 py-3 transition-all ${isScroll ? 'bg-black/80 backdrop-blur-md' : 'bg-transparent'}`}>
    <nav
      // className={`fixed top-5 w-full z-50 transition duration-300 px-[7vw] md:px-[7vw] lg:px-[20vw] 
...
//         {/* Desktop Menu */}
//         <ul className="hidden md:flex space-x-20 text-gray-300">
//           {menuItems.map((item) => (
//             <li
//               key={item.id}
//               className={`cursor-pointer hover:text-[#8245ec] ${
